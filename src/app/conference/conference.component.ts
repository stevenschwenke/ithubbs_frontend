...
export class ConferenceComponent implements OnInit {
  ...
  constructor() {
    this.talksBestPractice = [
      ...
      {portrait: 'lisa_rosenberg.jpg', speaker: 'Lisa Rosenberg', text: 'Ich möchte euch anhand meiner Erfahrungen das Thema <strong>Continuous Integration</strong> näher bringen. Außerdem möchte ich gern über <strong>Git</strong> reden, sodass euch der Einstieg in dieses wichtige Tool leichter fällt. Dabei gehe ich auf die wichtigsten Grundlagen, Best-Practices und typische Probleme ein.'},
      ...
      {portrait: 'josha.png', speaker: 'Josha von Gizycki', text: 'Die von Heroku entwickelte <strong>12 Factor App</strong> ist heutzutage so wichtig, dass man sie kennen sollte. Warum und was es damit auf sich hat, möchte ich euch gern darlegen.'},
      ];
    ...
    this.talksCommunity = [
      {portrait: 'Tim_Bourguignon.jpg', speaker: 'Tim Bourguignon ', text: 'Als Publisher des Podcasts "DevJourney" würde ich euch im <strong>Podcasting 101</strong> gern zeigen, was ich in 70 Folgen aufgenommener Podcasts gelernt habe.'},
      {portrait: 'lisa_rosenberg.jpg', speaker: 'Lisa Rosenberg', text: 'Seit Jahren beschäftige ich mich damit, wie wir <strong>Kinder und Jugendliche mit Workshops für die IT begeistern</strong> können. In dem Talk möchte ich meine Erfahrungen als Mentorin für Kinder und Jugendliche mit euch teilen und alle wichtigen Fragen in diesem Bezug klären.'},
